...
<head>
  ...
  $(document).ready(function() {
    ...
    $(function () {
      ...
      // window.alert('addDriver clicked');
...
<div id="addDriverDiv" class='addDriverDiv' name='addDriverDiv'>
    <h2><button id="addDriver" class='addDriver' type="button" name="addDriver"  input type="submit">+</button></h2>
</div>

<div id="driverUpload">
    <h1><button id='driverUpload' type="button" name="driverUpload" class="driverUpload" input type="submit">Load Drivers</button></h1>
</div>
     ...
     var userName = "<?php echo $userName; ?>";
      ...
      $('#saveNewDriver').click( function() {
         ...
         var data = {
            func : 'saveNewDriver',
               userName: userName,
 	       driverID: saveButton.parent().parent().find('[name=driverID]').val(),
 	       driverCell: saveButton.parent().parent().find('[name=driverCell]').val(),
          };
      $.ajax({
        type: "POST",
	dataType: "json",
