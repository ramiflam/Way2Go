...
fwrite($file,"In fleet select file. \n");
...
<div id="fleetUpload"> 
<form action="fleetUpload.php" method="post" enctype="multipart/form-data"  > 
    <h2> Upload Fleet File:</h2> <input name="csv" type="file" id="csv" accept=".csv" pattern=".{6,}" /> 
