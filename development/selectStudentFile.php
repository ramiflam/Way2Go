...
fwrite($file,"In student select file. \n");
...
<form action="studentUpload.php?schoolName=<?php echo $schoolName; ?>" method="post" enctype="multipart/form-data"  > 
    <h2> Upload Students File:</h2> <input name="csv" type="file" id="csv" accept=".csv" pattern=".{6,}" /> 
